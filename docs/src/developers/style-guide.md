...
!!! info
    The style guide is always a work in progress, and not all QuantumESPRESSOExtensions code
    follows the rules. When modifying QuantumESPRESSOExtensions, please fix the style violations
...
QuantumESPRESSOExtensions uses [JuliaFormatter](https://github.com/domluna/JuliaFormatter.jl) as
an auto-formatting tool.

We use the options contained in [`.JuliaFormatter.toml`](https://github.com/MineralsCloud/QuantumESPRESSOExtensions.jl/blob/main/.JuliaFormatter.toml).

To format your code, `cd` to the QuantumESPRESSOExtensions directory, then run:
...
!!! info
    A continuous integration check verifies that all PRs made to QuantumESPRESSOExtensions have
