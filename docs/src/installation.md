...
[QuantumESPRESSOExtensions](https://github.com/MineralsCloud/QuantumESPRESSOExtensions.jl).
...
## Install QuantumESPRESSOExtensions
...
2. Run the following commands and wait for them to finish:
   ...
   julia> Pkg.add("QuantumESPRESSOExtensions")
   ```

3. Run

   ```julia-repl
   julia> using QuantumESPRESSOExtensions
   ```
...
version of QuantumESPRESSOExtensions, type

```@repl
using Pkg
Pkg.update()
pkg"add https://github.com/MineralsCloud/QuantumESPRESSOExtensions.jl"
```

in the second step above.

## Update QuantumESPRESSOExtensions
...
our [GitHub repository](https://github.com/MineralsCloud/QuantumESPRESSOExtensions.jl)
for new releases.
Once we release a new version, you can update QuantumESPRESSOExtensions by typing

```@repl
using Pkg
Pkg.update("QuantumESPRESSOExtensions")
Pkg.gc()
```

in the Julia REPL.

## Uninstall and reinstall QuantumESPRESSOExtensions
...
1. To uninstall, in a Julia session, run
   ...
   julia> Pkg.rm("QuantumESPRESSOExtensions")

   julia> Pkg.gc()
   ```

2. Press `ctrl+d` to quit the current session. Start a new Julia session and
   reinstall QuantumESPRESSOExtensions.
